...
# Add Noto Emoji fonts: https://fonts.google.com/noto/specimen/Noto+Emoji
COPY missing-fonts/NotoEmoji/*.ttf /usr/share/fonts/
RUN chmod 0644 /usr/share/fonts/NotoEmoji-*.ttf
